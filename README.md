...
| **Antoine LENO**      | Backend Developer         | Front-end development (HTML, CSS, Bootstrap), template integration, UI customization, and JavaScript interactivity. <br> &nbsp;&nbsp;• Created user profile management for updating personal info and<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;viewing property subscriptions.<br> &nbsp;&nbsp;•  Implemented subscription payment functionality, allowing users to <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;securely pay for property subscriptions.<br> &nbsp;&nbsp;• Built an API for processing transactions, managing property payments and statuses.|
