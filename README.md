...
| **Antoine LENO**      | Backend Developer         | Front-end development (HTML, CSS, Bootstrap), template integration, UI customization, and JavaScript interactivity. <br> &nbsp;&nbsp;• Created user profile management for updating personal info and<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;viewing property subscriptions.<br> &nbsp;&nbsp;• Built program synopsis page displaying all related courses, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;resources, projects, and quizzes. <br> &nbsp;&nbsp;• Developed course content pages with access to resources, <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;projects, and quizzes. |
