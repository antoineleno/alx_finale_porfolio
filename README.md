...
| **Antoine LENO**      | Backend Developer         | Front-end development (HTML, CSS, Bootstrap), template integration, UI customization, and JavaScript interactivity. <br> &nbsp;&nbsp;• Created user profile management for updating personal info and<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;viewing property subscriptions.<br> &nbsp;&nbsp;•  Implemented subscription payment functionality, allowing users to <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;securely pay for property subscriptions.<br> &nbsp;&nbsp;• Built an API for processing transactions, managing property <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payments and statuses.<br> &nbsp;&nbsp;• Built the admin panel, enabling administrators to manage user accounts, property listings, and transactions.<br> &nbsp;&nbsp;• Built an API for processing transactions, managing property <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payments and statuses.<br> &nbsp;&nbsp;• Built an API for processing transactions, managing property <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;payments and statuses.|
